 ...
 */
public class SSXS_Fragment4 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.ssxs_fragment4, null);
    }

    @Override
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        super.onActivityCreated(savedInstanceState);
        lineChart = getView().findViewById(R.id.lineChart4);
        new Thread() {
            @Override
            public void run() {
                super.run();
    ...
    private void setData() {
        ...
        for (int i = 0; i < hjzbs.size(); i++) {
            ...
            entries.add(new Entry(i, hjzb.getCo2()));
