 ...
 */
public class SSXS_Fragment3 extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        lineChart = getView().findViewById(R.id.lineChart3);
        new Thread() {
            @Override
            public void run() {
                super.run();
    ...
    private void setData() {
        ...
        for (int i = 0; i < hjzbs.size(); i++) {
            ...
            entries.add(new Entry(i, hjzb.getPm25()));
